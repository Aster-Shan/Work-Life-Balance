                ...
                <div class="col-md-6">
                    <div class="content-box">
                        <div class="heading-container">
                            <h2 style ="color :green"> Admin Homepage</h2>
                            <p>Admin can  View / Delete / Edit all entries of the users who have enrolled. And Admin also access log out function. </p>
                        </div>
                        <p>
                          <br><br><br><br><br>  
                        </p>
